    ...
    (
      {
        ...
        # TODO: move to nushell scripts directory
        home.file."wz.nu".source = ./programs/nushell/wz.nu;
        ...
        programs.nushell = {
          ...
          envFile.source = ./programs/nushell/env.nu;
          extraConfig = ''
        ...
        programs.wezterm.extraConfig = builtins.readFile ./programs/wezterm/wezterm.lua;
      }
    )
